...
<h1 class="title">Fresh & White Deo</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="images/pic/10.jpg" class="img-responsive" alt="slide"></div>
...
<div class="room-features spacer">
  <div class="row">
    ...
    <p>Directions for Use: Apply 4-6 swipes per underarm. Allow the product to dry completely. Use daily for best results. Do not apply on irritated or damaged skin.</p>
    ...
    <h3>Ingredients</h3>    
    <ul>
     <li> Alcohol, Aluminum Chlorohydrate, Water, Glycerin, Arbutin </li>
      <li>Hydroxypropyl, Methylcellulose, Inidazolidinyl Urea</li>
      <li>Allantoin, Triclosan, Tetrasodium EDTA</li>
    </ul>
    ...
    <div class="col-sm-3 col-md-2">
      <div class="size-price">Price<span>Php 180.00</span></div>
    </div>
	<div class="col-sm-5 col-md-4">
<h3>Fill out to Order</h3>
    <form action="reserveD.php" role="form" class="wowload fadeInRight" method="POST" onSubmit="alert('Order Placed!');">
